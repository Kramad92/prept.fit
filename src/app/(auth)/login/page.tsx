...
function LoginForm() {
  ...
  return (
    <>
      ...
      {registered && (
        <div className="mb-4 rounded-lg bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 p-3 text-sm text-green-700 dark:text-green-400">
