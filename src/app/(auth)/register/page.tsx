...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-950 px-4 py-12" style={{ colorScheme: "dark" }}>
      ...
      <div className="pointer-events-none absolute inset-0 hidden overflow-hidden xl:block">
        {floatingPills.map((pill, i) => (
          ...
          >
            <div className="flex items-center gap-3 rounded-xl border border-brand-400/10 bg-brand-400/[0.03] px-4 py-3 shadow-[0_0_20px_rgba(132,204,22,0.06)] backdrop-blur-sm">
