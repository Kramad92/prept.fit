...
interface AIGenerateNutritionProgramProps {
  prompt: string;
...
export function AIGenerateNutritionProgram({
  prompt,
  durationWeeks,
  mealsPerDay,
  onGenerate,
}: AIGenerateNutritionProgramProps) {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      const res = await fetch("/api/ai/generate-nutrition-program", {
        method: "POST",
      ...
      {hasGenerated && (
        <>
          <input
            ...
            placeholder={t.programs.refinePromptPlaceholder || "Refine: e.g. 'more variety on weekends'..."}
